    ...
    <div class="p-5">
        ...
        <form action="{{route('update', $catalog->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input value=
                "{{$catalog->name}}"
                type="text" class="form-control form-color" id="" name="name">
            </div>
            ...
            <div class="mb-3">
                ...
                <input value=
                "{{$catalog->price}}"
                type="text" class="form-control form-color" id="" name="price" placeholder="e.g. Rp 5000">
            </div>
            ...
            <div class="mb-3">
                ...
                <input value=
                "{{$catalog->quantity}}"
                type="text" class="form-control form-color" id="" name="quantity" placeholder="5-80 characters">
            </div>
            ...
            <div class="mb-3">
                ...
                <img src=
                "{{ asset('storage/images/' . $catalog->image) }}"
                alt="Image Picture" width="150">
            </div>
